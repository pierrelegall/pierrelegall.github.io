...
<section id="post-here" class="space-y-5 sm:space-y-7">
  <div class="flex flex-col items-start gap-y-4 sm:items-baseline sm:flex-row sm:gap-y-0 justify-between">
    <h1 class="page-title text-3xl sm:text-4xl">
      ~> ls posts
    </h1>
