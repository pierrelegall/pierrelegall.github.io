...
description: |
  A firewall-based VPN killswitch is reliable - here's a simple script to setup UFW on GNU/Linux.
section: "computing"
tags: ["vpn", "firewall", "linux", "privacy"]
keywords: ["killswitch", "ufw"]
---

**TL;DR**: _A firewall-based VPN killswitch is the most reliable solution - here's a simple UFW script to set it up._
